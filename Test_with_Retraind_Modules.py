...
class Test_window(QWidget):
    def __init__(self, parent = None , model_name = "ELA", model_path = resource_remodel_path('ELA_147931.h5'), flag = "here"):
        super().__init__()
    ...
    def init_window(self):
        ...
        self.setWindowIcon(QtGui.QIcon(resource_path('icon.png'))) #icon Pic File name
