...
class ResultWindow(QDialog):
    def __init__(self , label ="Not Forged" , prob = 0.50 , model_path = resource_remodel_path('ELA_Model.h5'), model_name = "ELA"):
        super().__init__()
        self.title = "Result"
        self.top = 200
        self.left = 500
    ...
    def init_window(self, label, prob):
        ...
        self.setWindowIcon(QtGui.QIcon(resource_path('icon.png')))            #"icon.png"))
        ...
        self.button_Test_again.setIcon(QtGui.QIcon(resource_path('698827-icon-101-folder-search-512.png')))                 #"698827-icon-101-folder-search-512.png"))
        ...
        self.button_quit.setIcon(QtGui.QIcon(resource_path('cancel-symbol-transparent-9.png')))      #"cancel-symbol-transparent-9.png"))
