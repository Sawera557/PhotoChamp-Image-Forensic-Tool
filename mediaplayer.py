...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def open_file(self):
        path, _ = QFileDialog.getOpenFileName(self, "Open file", "", "mp3 Audio (*.mp3);mp4 Video (*.mp4);Movie files (*.mov);Movie files (*.mkv)")
...
def main():
    ...
    app.setStyle("Fusion")
    app.setApplicationDisplayName("Media Player")
    app.setWindowIcon(QtGui.QIcon(resource_path('icon.png') ))  #"D:\\fyp\\PhotoChamp_FYP-03\\PhotoChamp\\Icons\\icon.png"))
