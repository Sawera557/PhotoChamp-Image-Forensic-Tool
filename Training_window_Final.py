...
from PyQt5.QtWidgets import QApplication, QFileDialog, QFrame, QComboBox, QLineEdit, QLabel, QAction, QMessageBox, \
    QWidget, QPushButton
...
def resource_csv_path(relative_path):
    try:
        base_path = sys._MEIPASS
    except Exception:
        base_path = os.path.abspath("D:\FYP-3\PhotoChampEXE\CSV_files")

    return os.path.join(base_path, relative_path)


def resource_figure_path(relative_path):
    try:
        base_path = sys._MEIPASS
    except Exception:
        base_path = os.path.abspath("D:\FYP-3\PhotoChampEXE\Figures")
...
class Training_window(QWidget):
    ...
    def init_window(self):
        ...
        self.setWindowIcon(QtGui.QIcon(resource_path('icon.png')))  # "/Icons//icon.png"))   icon Pic File name
        ...
        self.button_1.setIcon(QtGui.QIcon(resource_path(
            '698831-icon-105-folder-add-512.png')))  # "D:\\fyp\\Image-Forgery-Detection-using-Deep-learning-master\\Image-Forgery-Detection-using-Deep-learning-master\\Icons\\698831-icon-105-folder-add-512.png")) #icon Pic File name
        ...
        self.button_2.setToolTip(
            "<h5>Browse image from your computer to start test!<h5>")  # Notice using h2 tags From Html
        self.button_2.setIcon(QtGui.QIcon(resource_path(
            '698831-icon-105-folder-add-512.png')))  # D:\\fyp\\Icons\\698831-icon-105-folder-add-512.png"))  # icon Pic File name
        ...
        self.button_3.setToolTip(
            "<h5>Browse image from your computer to start test!<h5>")  # Notice using h2 tags From Html
        self.button_3.setIcon(QtGui.QIcon(resource_path('create.png')))  # "\Icons\\create.png"))  # icon Pic File name
        ...
        self.button.setIcon(QtGui.QIcon(resource_path(
            '698827-icon-101-folder-search-512.png')))  # "D:\\fyp\\Image-Forgery-Detection-using-Deep-learning-master\\Image-Forgery-Detection-using-Deep-learning-master\\Icons\\698827-icon-101-folder-search-512.png")) #icon Pic File name
        ...
        self.button.setToolTip("<h5>test image either Forged or Not Forged!<h5>")  # Notice using h2 tags From Html
        self.button.setIcon(QtGui.QIcon(resource_path(
            'repeat-pngrepo-com.png')))  # "D:\\fyp\\Image-Forgery-Detection-using-Deep-learning-master\\Image-Forgery-Detection-using-Deep-learning-master\\Icons\\repeat-pngrepo-com.png")) #icon Pic File name
        self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
        ...
        self.button_4.setIcon(QtGui.QIcon(resource_path(
            'Rocket-icon-blue.png')))  # "D:\\fyp\\Image-Forgery-Detection-using-Deep-learning-master\\Image-Forgery-Detection-using-Deep-learning-master\\Icons\\Rocket-icon-blue.png")) #icon Pic File name
        ...
        self.button.setIcon(QtGui.QIcon(resource_path(
            'cancel-symbol-transparent-9.png')))  # "\\PhotoChamp_FYP-03\\PhotoChamp\\Icons\\cancel-symbol-transparent-9.png"))icon Pic File name
        self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
        ...
        # self.button.setIcon(QtGui.QIcon("D:\\fyp\\Image-Forgery-Detection-using-Deep-learning-master\\Image-Forgery-Detection-using-Deep-learning-master\\Icons\\icons8-faq-100 (1).png")) #icon Pic File name
        # self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
    ...
    def Make_CSV_file(self):
        if self.file_path_Tampered == "" or self.file_path_Authentic == "":
            ...
            msg.setWindowIcon(QtGui.QIcon(
                resource_path('icon.png')))  # "D:\\fyp\\PhotoChamp_FYP-03\\PhotoChamp\\Icons\\icons8-cbs-512.ico"))
            msg.exec_()
        else:
    ...
    def on_click(self):
        if self.file_path_Authentic == "" or self.file_path_Tampered == "" or self.csv_file == "":
            msg = QMessageBox()
            msg.setIcon(QMessageBox.Critical)
            msg.setText("Browse Authentic Directory or Tampered Directory and Create Csv File")
            msg.setWindowTitle("Error")
            msg.setWindowIcon(QtGui.QIcon(
                resource_path('icon.png')))  # "D:\\fyp\\PhotoChamp_FYP-03\\PhotoChamp\\Icons\\icons8-cbs-512.ico"))
            msg.exec_()
