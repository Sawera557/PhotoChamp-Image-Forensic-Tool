...
a 'Quit' button.e Instead, the ESCAPE key can be used, or cancelling the form.
...
class PDF_veiw(object):
    def __init__(self):
        super().__init__()
        self.title = "PhotoChamp IFT App"
        self.WindowIcon = resource_path('icon.png')
        self.init_window()
    ...
    def init_window(self):
        ...
        # ------------------------------------------------------------------------------
        root = tk.Tk()
        max_width = root.winfo_screenwidth() - 10
